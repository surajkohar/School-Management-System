...
import { updateEmployee, setCurrentEmployee } from '../../store/slices/employeeSlice.js';
...
const EmployeeEdit = () => {
  ...
  return (
    <div className="employee-edit animate-slide-in">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1 className="h3 fw-bold">Edit Employee</h1>
        <button 
